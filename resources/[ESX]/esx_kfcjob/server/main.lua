...
AddEventHandler('esx_burgerjob:startHarvest', function(zone)
  ...
  if PlayersHarvesting[_source] == false then
    TriggerClientEvent('esx:showNotification', _source, '~r~Glitch ist nicht gut ~w~')
...
AddEventHandler('esx_burgerjob:stopHarvest', function()
  ...
  if PlayersHarvesting[_source] == true then
    PlayersHarvesting[_source]=false
    TriggerClientEvent('esx:showNotification', _source, 'Du hast die  ~r~Zone verlassen')
  else
    TriggerClientEvent('esx:showNotification', _source, 'Sie können die ~g~Kisten sammeln')
    PlayersHarvesting[_source]=true
  end
end)
...
AddEventHandler('esx_burgerjob:stopTransform', function()
  ...
  if PlayersTransforming[_source] == true then
    ...
    TriggerClientEvent('esx:showNotification', _source, 'Sie können Ihren Ketchup einpacken')
    PlayersTransforming[_source]=true
  end
end)
