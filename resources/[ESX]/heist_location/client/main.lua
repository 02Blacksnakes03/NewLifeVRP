...
function OpenVehicleMenu() -- Menu location véhicules
    ...
    local elements = {
        {label = 'Motorboot', value = 'seashark', price = 500},
        {label = 'Surfbrett', value = 'surfboard', price = 500}
    }
    ...
    ESX.UI.Menu.Open(
        ...
        {
            title = 'Verleih von Boards', -- Titre du menu
            elements = elements
        },
        function(data, menu)
    ...
    function(data, menu)
        ...
        CurrentActionMsg  = '~INPUT_CONTEXT~ Drücken um das Menü zu öffnen'
        CurrentActionData = {}
    end
    )
end
...
Citizen.CreateThread(function()	
	...
	AddTextComponentString("Area de Surf")
