...
function ProcessWeed()
	...
	TriggerServerEvent('esx_aramid:processCannabis')
	...
	while timeLeft > 0 do
		...
		if GetDistanceBetweenCoords(GetEntityCoords(playerPed), Config.CircleZones.WeedProcessing.coords, false) > 4 then
			...
			TriggerServerEvent('esx_aramid:cancelProcessing')
			break
		end
	end
	...
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_aramid:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_aramid:pickedUpCannabis')
					else
...
--		ESX.Game.SpawnLocalObject('prop_weed_02', weedCoords, function(obj)
		ESX.Game.SpawnLocalObject('prop_plant_flower_01', weedCoords, function(obj)
