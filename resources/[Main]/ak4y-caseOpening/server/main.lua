...
ESX.RegisterServerCallback('ak4y-caseOpening:getPlayerDetails', function(source, cb)
    local src = source
...
ESX.RegisterServerCallback('ak4y-caseOpening:selectedCaseOpen', function(source, cb, caseData, itemData)
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    local citizenId = xPlayer.identifier
...
ESX.RegisterServerCallback('ak4y-caseOpening:collectItem', function(source, cb, itemData, caseData)  
...
ESX.RegisterServerCallback('ak4y-caseOpening:sellItem', function(source, cb, caseData, itemData)
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    local citizenId = xPlayer.identifier
    local result = ExecuteSql("SELECT * FROM ak4y_caseopening WHERE citizenid = '"..citizenId.."'")
...
ESX.RegisterServerCallback('ak4y-caseOpening:sendInput', function(source, cb, data)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    local citizenId = xPlayer.identifier
