...
AddEventHandler('esx_extraitems:bulletproof', function()
	...
	SetPedComponentVariation(playerPed, 9, 15, 2, 0)
	AddArmourToPed(playerPed, 100)
	SetPedArmour(playerPed, 100)
end)

RegisterNetEvent('esx_extraitems:fbulletproof')
AddEventHandler('esx_extraitems:fbulletproof', function()
	local playerPed = GetPlayerPed(-1)

	SetPedComponentVariation(playerPed, 9, 16, 2, 0)
