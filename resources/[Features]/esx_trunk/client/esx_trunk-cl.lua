...
Citizen.CreateThread(function()
  while true do
    Wait(0)
    if IsControlJustPressed(0, Keys["Z"]) and (GetGameTimer() - GUI.Time) > 1000  then
      TriggerEvent('trunkopen123')
    elseif lastOpen and IsControlJustPressed(0, Keys["BACKSPACE"]) and (GetGameTimer() - GUI.Time) > 150 then
