local Components = {
	...
	{label = _U('face_mom'),				name = 'face_mom',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('face_dad'),				name = 'face_dad',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('face_similarity'),			name = 'face_similarity',	value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('face_complexion'),			name = 'face_complexion',	value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
...
function ApplySkin(skin, clothes)
	...
	if clothes ~= nil then
		for k,v in pairs(clothes) do
			if
				...
				k ~= 'face_mom'			and
				k ~= 'face_dad'			and
				k ~= 'face_similarity'	and
				k ~= 'face_complexion'  and
				k ~= 'skin'				and
				k ~= 'age_1'			and
				k ~= 'age_2'			and
				k ~= 'eye_color'		and
	...
	if Character['face_mom'] == 0 and Character['face_dad'] == 0 then
		...
		SetPedHeadBlendData(playerPed, Character['face_mom'], Character['face_dad'], nil, Character['face_mom'], Character['face_dad'], nil, Character['face_similarity'],  Character['face_complexion'], nil, true)
	end
